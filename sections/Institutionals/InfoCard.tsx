...
const InfoCard = (
  { imageDesktop, imageMobile, title, subtitle, button, type }: Props,
) => {
  ...
  return (
    <a
      href={button?.link}
      class={`${
        type === "first" ? "h-[390px] lg:h-[530px]" : "h-[400px] lg:h-[400px]"
      }  bg-cover bg-center flex flex-col items-center pb-[60px] lg:pb-0 justify-end lg:justify-center`}
      style={{
        backgroundImage: `url(${
          device === "desktop" ? imageDesktop : imageMobile
        })`,
      }}
    >
      <div
