            ...
            <div>
                <div class="grid grid-cols-2 gap-5">
                    ...
                    {benefits?.commercial && (
                        <div>
                            <div class="bg-[#0A0A0A] p-3 rounded-lg max-w-12 w-fit mb-1 flex items-center justify-center">
                                <Icon height={22} width={22} class="bg-[##0A0A0A]" id={"commercialHours"} />
                            </div>
                            <p class="uppercase text-[#717171] flex flex-row items-center gap-3">
                    ...
                    {benefits?.mealVoucher && (
                        <div>
                            <div class="bg-[#0A0A0A] p-3 rounded-lg max-w-12 w-fit mb-1 flex items-center justify-center">
                                <Icon height={22} width={22} class="bg-[##0A0A0A]" id={"mealVouchers"} />
                            </div>
                            <p class="uppercase text-[#717171] flex flex-row items-center gap-3">
                    ...
                    {benefits?.healthPlan && (
                        <div>
                            <div class="bg-[#0A0A0A] p-3 rounded-lg max-w-12 w-fit mb-1 flex items-center justify-center">
                                <Icon height={22} width={22} class="bg-[##0A0A0A]" id={"healthPlaning"} />
                            </div>
                            <p class="uppercase text-[#717171] flex flex-row items-center gap-3">
                    ...
                    {benefits?.personalDevelopmentPlan && (
                        <div>
                            <p class="uppercase text-[#717171] flex flex-row items-center gap-3">
                                pdi (plano de desenvolvimento individual) após 3 meses de empresa
                            </p>
                            <div class="bg-[#0A0A0A] p-3 rounded-lg max-w-12 w-fit mb-1 flex items-center justify-center">
                                <Icon height={22} width={32} class="bg-[##0A0A0A]" id={"personalDevelopmentPlaning"} />
                            </div>
                        </div>
                    )}
                </div>
