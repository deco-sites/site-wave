      ...
      <div class="container flex flex-col lg:flex-row justify-between px-5 lg:px-0">
        <div>
          ...
          <div class="flex items-center gap-5 lg:gap-12 flex-row lg:flex-row mb-5 lg:mb-0">
            <img width={device === "mobile" ? 148 : 296} height={device === "mobile" ? 116 : 232} src={props?.gptwImage} alt={props?.title}/>
        ...
        <div>
          <img class="rounded-[20px]" src={props?.src} alt={props?.title} width={device === "mobile" ? 350 : 460} height={device === "mobile" ? 260 : 460}/>
        </div>
      </div>
    </div>);
};
