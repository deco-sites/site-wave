...
const ImageWithText = ({ images, text, reverse }: Props) => {
    ...
    return (<div>
      <div class={`container px-4 lg:px-0 flex flex-col lg:flex-row ${reverse && "lg:flex-row-reverse flex-col-reverse justify-between"} items-center ${!reverse && "justify-around"}`}>
        <img src={imageSrc || ""} alt={AlternativeText || ""}/>
