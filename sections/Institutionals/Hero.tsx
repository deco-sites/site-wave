...
export default function Hero({
  ...
  const {
    desktop: { src: srcDesktop = "", height: desktopHeight = 820 },
    mobile: { src: srcMobile = "", height: mobileHeight = 0 },
  } = bgImage;
      ...
      <div class="container px-5 lg:p-0 relative z-20 lg:w-full sm:w-2/3 m-auto">
        ...
        {labelBottom && (
          <div class="flex flex-col items-start gap-3">
            ...
            <p
              class="text-[#717171] text-sm"
              dangerouslySetInnerHTML={{ __html: labelBottom.text }}
            />
          </div>
        )}
        {findOutMore && (
