      ...
      >
        ...
        <div class="w-4/12">
          <div class="flex justify-center">
            <a
              class="w-fit flex py-[11px] px-3 gap-1 items-center bg-[#0066E4] rounded-[30px] group border-2 border-[#0066e4] hover:bg-transparent text-white transition duration-350 ease-in hover:ease-out text-xs"
              href={cta?.link}
            >
              {cta?.label}
            </a>
