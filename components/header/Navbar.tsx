...
function Navbar({ items, logo, device, cta }: Props) {
      ...
      >
        ...
        <div class="w-4/12">
          <div class="flex justify-center">
            <a
              class="flex py-[5px] px-3 gap-1 items-center bg-[#0066E4] rounded-[30px] group border border-white hover:bg-transparent text-white transition duration-350 ease-in hover:ease-ou"
              href={cta?.link}
            >
              Contato
  ...
  return (
    <div class="hidden container sm:flex items-center w-full space-between py-3">
      ...
      <div>
        <a
          class=" flex py-[5px] px-3 gap-1 items-center bg-[#0066E4] rounded-[30px] group border border-white hover:bg-transparent text-white transition duration-350 ease-in hover:ease-out "
          href={cta?.link}
        >
          {cta?.label}
          <svg
